...
const milestones = [
  { year: '2024', label: 'Founded', desc: 'NexaSphere was proposed and formed at GL Bajaj, Mathura.', icon: '🚀' },
  { year: 'Mar 2025', label: 'KSS #153', desc: 'Inaugural Knowledge Sharing Session on Impact of AI — 3 presenters, 5 volunteers.', icon: '🧠' },
  { year: '2025', label: 'Growing', desc: '12 core team members, 7 activity tracks, and a thriving community.', icon: '🌱' },
  { year: 'Future', label: 'Expanding', desc: 'Hackathons, workshops, open-source days and more in the pipeline.', icon: '🔭' },
];
      ...
      <div className="container">
        ...
        <div style={{ marginBottom: '70px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
            {values.map((v, i) => (
              <div key={v.label} className="pop-in" style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--c1b)'; e.currentTarget.style.boxShadow = 'var(--sh1)'; e.currentTarget.style.transform = 'translateY(-4px)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--bdr)'; e.currentTarget.style.boxShadow = ''; e.currentTarget.style.transform = ''; }}
              >
          ...
          <div className="events-timeline">
            {milestones.map((m, i) => (
              <div className="timeline-item" key={i}>
                <div className="timeline-dot" style={i === 3 ? { background: 'transparent', border: '2px solid var(--c1)', animation: 'pulse 2s infinite' } : {}} />
