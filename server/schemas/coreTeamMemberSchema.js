...
export const coreTeamMemberSchema = coreTeamMemberBaseSchema.transform(
  (data) => ({
    ...data,
...
export const coreTeamMemberPatchSchema = coreTeamMemberBaseSchema
  .partial()
  .transform((data) => ({
    ...data,
    email: data.email
      ? sanitizeText(data.email, 140).toLowerCase()
      : data.email,
  }));
