...
export function RolesManager() {
  ...
  const [roles, setRoles] = useState([
    {
      ...
      permissions: ["events:read", "events:write", "settings:admin"],
    },
    {
      id: 2,
      name: "Event Manager",
      description: "Can manage events and registrations",
      permissions: ["events:read", "events:write"],
    },
    {
      id: 3,
      name: "Content Moderator",
      description: "Can review and moderate forum posts",
  ...
  const handleDeleteRole = (id) => {
    if (
      !window.confirm(
        "Delete this role? Any admins with this role will lose their permissions."
      )
    )
      return;
  ...
  if (loading)
    return (
      <div style={{ padding: 20, color: "var(--text)" }}>Loading Roles...</div>
    );
    ...
    <div className="page" style={{ maxWidth: "1200px", margin: "0 auto" }}>
      <div className="page-header">
        <div>
          ...
          <p style={{ color: "var(--text2)", marginTop: "4px" }}>
            Manage admin roles and invite team members to co-manage the platform
            securely.
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "30px" }}>
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "18px", margin: 0, color: "var(--text)" }}>
              Roles
            </h2>
            <button
                    ...
                    >
                      ...
                      <td
                        style={{
                          padding: "12px 8px",
                          color:
                            admin.status === "Active" ? "#22c55e" : "#eab308",
                        }}
                      >
                        {admin.status}
                      </td>
